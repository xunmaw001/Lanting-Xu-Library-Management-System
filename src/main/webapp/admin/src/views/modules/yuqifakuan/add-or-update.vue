    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="罚款金额" prop="yuqifakuanNumber">
                       <el-input v-model="ruleForm.yuqifakuanNumber"
                                 placeholder="罚款金额" clearable  :readonly="ro.yuqifakuanNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="罚款金额" prop="yuqifakuanNumber">
                           <el-input v-model="ruleForm.yuqifakuanNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="罚款原因" prop="qinyoumokuaiText">
                        <el-input type="textarea"  :readonly="ro.qinyoumokuaiText" v-model="ruleForm.qinyoumokuaiText" placeholder="罚款原因"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qinyoumokuaiText" label="罚款原因" prop="qinyoumokuaiText">
                            <span v-html="ruleForm.qinyoumokuaiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yuqifakuanNumber: false,
                    qinyoumokuaiText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   qinyoumokuaiText: [
                              { required: true, message: '罚款原因不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yuqifakuan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yuqifakuanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
