...
import center from '@/views/center'
    ...
    import shukanjuanzeng from '@/views/modules/shukanjuanzeng/list'
    ...
    import yuqifakuan from '@/views/modules/yuqifakuan/list'
